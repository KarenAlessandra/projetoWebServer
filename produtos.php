        ...
        <div class="containerPage">
            ...
            <div class="container2" style="border-radius: 1%; padding-right: 30px !important">
                ...
                <div class="row text-center">
                    ...
                    <div class="col-lg-3 col-sm-6 col-xl-2">
                        <div class="card chama">
                            <img src="./assets/8.png" class="img-fluid">
                            <br />
                            <p>blablablabla</p>
                            <h4 class="Price">29,00</h4>
                        </div>
                    ...
                    <div class="col-lg-3 col-sm-6 col-xl-2">
                        <div class="card chama">
                            <img src="./assets/11.png" class="img-fluid">
                            <br />
                            <p>blablablabla</p>
                            <h4 class="Price">29,00</h4>
                        </div>
                    ...
                    <div class="col-lg-3 col-sm-6 col-xl-2">
                        <div class="card chama">
                            <img src="./assets/13.png" class="img-fluid">
                            <br />
                            <p>blablablabla</p>
                            <h4 class="Price">29,00</h4>
                        </div>
                    ...
                    <div class="col-lg-3 col-sm-6 col-xl-2">
                        <div class="card chama">
                            <img src="./assets/14.png" class="img-fluid">
                            <br />
                            <p>blablablabla</p>
                            <h4 class="Price">29,00</h4>
                        </div>
                    ...
                    <div class="col-lg-3 col-sm-6 col-xl-2">
                        <div class="card chama">
                            <img src="./assets/16.png" class="img-fluid">
                            <br />
                            <p>blablablabla</p>
                            <h4 class="Price">29,00</h4>
                        </div>
...
>>>>>>> 199e354f60c1af16d1f3fe6976fe61c9eb7f1d3c
                        <li class="page-item">
